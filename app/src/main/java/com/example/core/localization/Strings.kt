...
val SpanishStrings = EnglishStrings.copy(
    ...
    search = "Buscar",
    welcomeTitle = "Libro de Rendición de Cuentas CMFI",
    welcomeSubtitle = "Herramienta digital para disciplinas espirituales y crecimiento en el discipulado cristiano.",
    continueAsGuest = "Continuar como invitado",
    guestExplanation = "Puede registrar todas sus actividades localmente sin cuenta. Inicie sesión en cualquier momento para sincronizar.",
    ...
    guestAccountNotice = "Modo invitado (Almacenamiento local)",
    greetingMorning = "Buenos días",
    greetingAfternoon = "Buenas tardes",
    greetingEvening = "Buenas noches",
    todaysProgress = "Progresos de Hoy",
    completedDomains = "Completados",
    remainingDomains = "Restantes",
    ...
    noRecentActivities = "Sin actividades registradas hoy.",
    searchDomains = "Buscar disciplinas espirituales...",
    spiritualDisciplines = "Disciplinas Espirituales",
    save = "Guardar",
    delete = "Eliminar",
    edit = "Editar",
    notes = "Notas y Reflexión",
...
val PortugueseStrings = EnglishStrings.copy(
    ...
    search = "Pesquisar",
    welcomeTitle = "Livro de Prestação de Contas CMFI",
    welcomeSubtitle = "Ferramenta digital para disciplinas espirituais e crescimento no discipulado cristão.",
    continueAsGuest = "Continuar como Convidado",
    guestExplanation = "Você pode registrar todas as atividades localmente sem uma conta. Faça login a qualquer momento para sincronizar.",
    ...
    logout = "Sair",
    guestAccountNotice = "Modo Convidado (Armazenamento local)",
    greetingMorning = "Bom dia",
    greetingAfternoon = "Boa tarde",
    greetingEvening = "Boa noite",
    todaysProgress = "Progresso de Hoje",
    completedDomains = "Concluídos",
    remainingDomains = "Restantes",
    ...
    noRecentActivities = "Nenhuma atividade registrada hoje.",
    searchDomains = "Pesquisar disciplinas espirituais...",
    spiritualDisciplines = "Disciplinas Espirituais",
    save = "Salvar",
    delete = "Excluir",
    edit = "Editar",
    notes = "Notas e Reflexão",
...
val SwahiliStrings = EnglishStrings.copy(
    appName = "CMFI Accountability",
    dashboard = "Nyumbani",
    domains = "Nyanja",
    calendar = "Kalenda",
    ...
    search = "Tafuta",
    welcomeTitle = "Kitabu cha Uwajibikaji cha CMFI",
    welcomeSubtitle = "Chombo cha kidijitali cha nidhamu za kiroho na ukuaji katika uanafunzi wa Kikristo.",
    continueAsGuest = "Endelea kama Mgeni",
    guestExplanation = "Unaweza kuhifadhi shughuli zote kwenye kifaa chako bila akaunti.",
    signInWithGoogle = "Ingia kwa Google",
    signInWithEmail = "Ingia kwa Barua pepe",
    email = "Barua pepe",
    password = "Nenosiri",
    signIn = "Ingia",
    ...
    logout = "Ondoka",
    guestAccountNotice = "Hali ya Mgeni (Hifadhi ya ndani)",
    ...
    completedDomains = "Yamekamilika",
    remainingDomains = "Yaliyobaki",
    currentStreak = "Mfululizo wa Sasa",
    longestStreak = "Mfululizo Mrefu Zaidi",
    days = "siku",
    quickAdd = "Kumbukumbu ya Haraka",
    recentActivities = "Shughuli za Hivi Karibuni",
    upcomingReminders = "Kikumbusho Kinachofuata",
    noRecentActivities = "Hakuna shughuli zilizorekodiwa leo.",
    searchDomains = "Tafuta nidhamu za kiroho...",
    spiritualDisciplines = "Nidhamu za Kiroho",
    save = "Hifadhi",
    delete = "Futa",
    edit = "Hariri",
    notes = "Mawazo na Maelezo",
    appearance = "Muonekano",
    theme = "Hali ya Mandhari",
    language = "Lugha",
    signOut = "Ondoka"
)

val ArabicStrings = EnglishStrings.copy(
    appName = "CMFI Accountability",
    dashboard = "الرئيسية",
    domains = "المجالات",
    calendar = "التقويم",
    ...
    search = "بحث",
    welcomeTitle = "كتاب المساءلة الروحية CMFI",
    welcomeSubtitle = "أداة رقمية للمساءلة عن التخصصات الروحية والنمو في التلمذة المسيحية.",
    continueAsGuest = "المتابعة كضيف",
    guestExplanation = "يمكنك تسجيل جميع الأنشطة محليًا بدون حساب.",
    ...
    logout = "تسجيل الخروج",
    guestAccountNotice = "وضع الضيف (تخزين محلي)",
    greetingMorning = "صباح الخير",
    greetingAfternoon = "مساء الخير",
    greetingEvening = "مساء الخير",
    todaysProgress = "تقدم اليوم",
    completedDomains = "المكتملة",
    remainingDomains = "المتبقية",
    ...
    noRecentActivities = "لا توجد أنشطة مسجلة اليوم.",
    searchDomains = "البحث في الانضباطات الروحية...",
    spiritualDisciplines = "التخصصات الروحية",
    save = "حفظ",
    delete = "حذف",
    edit = "تعديل",
    notes = "ملاحظات وتأملات",
    appearance = "المظهر",
    theme = "وضع المظهر",
    language = "اللغة",
